...
function SideNavBar(){
  ...
  <SideNav.Nav defaultSelected="home">
    ...
    <NavItem eventKey="teachers">
      ...
      <Link to="test" className="text-white nav-item">Test</Link>
    </NavItem>
    <NavItem eventKey="students">
      ...
      <Link to="" className="text-white nav-item">Students</Link>
    </NavItem>
    <NavItem eventKey="groups">
      ...
      <Link to="" className="text-white nav-link">Groups</Link>
    </NavItem>
